...
(unless (fboundp 'cl--define-built-in-type) (defun cl--define-built-in-type (&rest _) nil))
...
(unless (fboundp 'define-inline) (defun define-inline (&rest _) nil))
...
(unless (fboundp 'eval-and-compile) (defun eval-and-compile (&rest _) nil))
(unless (fboundp 'eval-buffer) (defun eval-buffer (&rest _) nil))
(unless (fboundp 'eval-when-compile) (defun eval-when-compile (&rest _) nil))
...
(unless (fboundp 'oclosure-define) (defun oclosure-define (&rest _) nil))
(unless (fboundp 'oclosure-lambda) (defun oclosure-lambda (&rest _) nil))
...
(unless (fboundp 'pcase-defmacro) (defun pcase-defmacro (&rest _) nil))
(unless (fboundp 'pcase-dolist) (defun pcase-dolist (&rest _) nil))
(unless (fboundp 'pcase-exhaustive) (defun pcase-exhaustive (&rest _) nil))
(unless (fboundp 'pcase-let) (defun pcase-let (&rest _) nil))
...
(unless (fboundp 'with-help-window) (defun with-help-window (&rest _) nil))
